...
def test_basic_summary():
    current = [
        ...
        AggregateBucket(period="2026-03", category="Muni Bus", count=5, total_fare=12.50),
    ]
    previous = [
...
def test_diff_text_fewer():
    current = [AggregateBucket(period="2026-03", category="BART", count=5, total_fare=20.0)]
    previous = [AggregateBucket(period="2026-02", category="BART", count=10, total_fare=40.0)]
    result = compute_summary(current, previous, most_recent_date="2026-03-15")
...
def test_diff_text_more():
    current = [AggregateBucket(period="2026-03", category="BART", count=10, total_fare=40.0)]
    previous = [AggregateBucket(period="2026-02", category="BART", count=5, total_fare=20.0)]
    result = compute_summary(current, previous, most_recent_date="2026-03-15")
